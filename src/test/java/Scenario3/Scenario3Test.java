...
public class Scenario3Test {
    ...
    public void testSearchFunctionality() throws InterruptedException {
        ...
        assertEquals(
                "https://www.univerzalno.com/bs/search?any_collection_id=&q=iphone+13",
                webDriver.getCurrentUrl()
        );

        WebElement iphone13 = webDriver.findElement(
    ...
    public void testSearchFunctionalityFailed() throws InterruptedException {
        ...
        WebElement noResultMessage = webDriver.findElement(
                By.xpath("//*[@id=\"search-filters-form\"]/section/div/div/div/div[1]/div")
        );
